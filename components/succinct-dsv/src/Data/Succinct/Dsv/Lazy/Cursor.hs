module Data.Succinct.Dsv.Lazy.Cursor
  ( DsvCursor (..)
  , makeCursor
  , trim
  , atEnd
...
import qualified Data.Succinct.Dsv.Internal.Char   as C
import qualified Data.Succinct.Dsv.Internal.Vector as DVS
import qualified Data.Succinct.Simd.Comparison     as DVS
