...
import Data.Word
import Data.Succinct.Dsv.Internal.Char (comma, pipe)
...
import qualified Data.Succinct.RankSelect.CsPoppy                   as RS
...
makeBenchCsv = do
  entries <- listDirectory "components/succinct-dsv/data/bench"
