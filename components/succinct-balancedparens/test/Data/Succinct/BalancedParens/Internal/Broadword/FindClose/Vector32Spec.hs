...
module Data.Succinct.BalancedParens.Internal.Broadword.FindClose.Vector32Spec
  ( spec
  ) where
...
import qualified Data.Succinct.BalancedParens.Internal.Broadword.FindClose.Vector32 as V32
...
spec :: Spec
spec = describe "Data.Succinct.BalancedParens.Internal.Broadword.FindClose.Vector32Spec" $ do
