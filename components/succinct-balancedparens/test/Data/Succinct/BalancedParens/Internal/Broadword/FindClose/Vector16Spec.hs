...
module Data.Succinct.BalancedParens.Internal.Broadword.FindClose.Vector16Spec
  ( spec
  ) where
...
import qualified Data.Succinct.BalancedParens.Internal.Broadword.FindClose.Vector16 as V16
...
spec :: Spec
spec = describe "Data.Succinct.BalancedParens.Internal.Broadword.FindClose.Vector16Spec" $ do
