module Data.Succinct.BalancedParens.Internal.Broadword.FindClose.Word32
  ( findClose
  ) where
...
import qualified Data.Succinct.BalancedParens.Internal.Broadword.FindUnmatchedCloseFar.Word32 as W32
