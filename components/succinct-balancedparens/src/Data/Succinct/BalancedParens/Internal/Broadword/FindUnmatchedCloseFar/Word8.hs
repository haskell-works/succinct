...
module Data.Succinct.BalancedParens.Internal.Broadword.FindUnmatchedCloseFar.Word8
...
--
-- This is the broadword implementation of 'Data.Succinct.BalancedParens.Internal.Slow.Word8.findCloseFor'.
--
