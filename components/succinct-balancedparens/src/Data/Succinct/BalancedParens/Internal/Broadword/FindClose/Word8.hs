module Data.Succinct.BalancedParens.Internal.Broadword.FindClose.Word8
  ( findClose
  ) where
...
import qualified Data.Succinct.BalancedParens.Internal.Broadword.FindUnmatchedCloseFar.Word8 as W8
