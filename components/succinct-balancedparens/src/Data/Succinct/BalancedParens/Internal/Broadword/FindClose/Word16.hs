module Data.Succinct.BalancedParens.Internal.Broadword.FindClose.Word16
  ( findClose
  ) where
...
import qualified Data.Succinct.BalancedParens.Internal.Broadword.FindUnmatchedCloseFar.Word16 as W16
