...
module Data.Succinct.RankSelect.InternalSpec (spec) where

import Data.Maybe
import Data.Succinct.RankSelect.Base.Rank
import Data.Succinct.RankSelect.Base.Select
...
spec :: Spec
spec = describe "Data.Succinct.RankSelect.InternalSpec" $ do
