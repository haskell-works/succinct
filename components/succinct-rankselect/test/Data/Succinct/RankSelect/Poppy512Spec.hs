...
module Data.Succinct.RankSelect.Poppy512Spec (spec) where
...
import qualified Data.Succinct.RankSelect.Gen as G
...
spec :: Spec
spec = describe "Data.Succinct.RankSelect.Poppy512.Rank1Spec" $ do
