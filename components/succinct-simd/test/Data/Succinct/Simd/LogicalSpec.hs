...
module Data.Succinct.Simd.LogicalSpec (spec) where
...
import qualified Data.Succinct.Simd.Logical.Avx2  as AVX
import qualified Data.Succinct.Simd.Logical.Stock as STK
...
spec :: Spec
spec = describe "Data.Succinct.Simd.LogicalSpec" $ do
  when avx2Enabled $ do
    describe "xorBits" $ do
