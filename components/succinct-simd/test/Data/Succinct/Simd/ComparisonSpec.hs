...
module Data.Succinct.Simd.ComparisonSpec (spec) where
...
import qualified Data.Succinct.Simd.Comparison.Avx2  as AVX
import qualified Data.Succinct.Simd.Comparison.Stock as STK
...
spec :: Spec
spec = describe "Data.Succinct.Simd.ComparisonSpec" $ do
  when avx2Enabled $ do
