...
import qualified Data.Succinct.Simd.Capabilities     as CAP
import qualified Data.Succinct.Simd.Comparison.Avx2  as AVX2
import qualified Data.Succinct.Simd.Comparison.Stock as STOCK
import qualified Data.Succinct.Simd.Logical.Avx2     as AVX2
import qualified Data.Succinct.Simd.Logical.Stock    as STOCK
...
benchcmpEqWord8s = do
  entries <- IO.listDirectory "components/succinct-simd/data/bench"
  let files = ("components/succinct-simd/data/bench/" ++) <$> (".csv" `L.isSuffixOf`) `filter` entries
