...
module Data.Succinct.Excess.PartialMinExcess1Spec (spec) where

import Data.Succinct.Excess.MinExcess1
import Data.Succinct.Excess.PartialMinExcess1
...
spec :: Spec
spec = describe "Data.Succinct.Excess.PartialMinExcess1Spec" $ do
