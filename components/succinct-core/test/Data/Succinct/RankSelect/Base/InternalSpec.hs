module Data.Succinct.RankSelect.Base.InternalSpec
  ( spec
  ) where

import Control.Monad                              (mfilter)
import Data.Bits                                  (popCount)
import Data.Succinct.RankSelect.Base.Internal
...
spec :: Spec
spec = describe "Data.Succinct.RankSelect.Base.InternalSpec" $ do
