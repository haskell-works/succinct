module Data.Succinct.BalancedParens.Internal.Broadword.FindClose.Vector64Spec
  ( spec
  ) where
...
import qualified Data.Succinct.BalancedParens.Internal.Broadword.FindClose.Vector64 as V64
...
spec :: Spec
spec = describe "Data.Succinct.BalancedParens.Internal.Broadword.FindClose.Vector64Spec" $ do
