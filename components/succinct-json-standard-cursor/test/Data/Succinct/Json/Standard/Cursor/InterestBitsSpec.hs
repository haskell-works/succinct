...
module Data.Succinct.Json.Standard.Cursor.InterestBitsSpec(spec) where
...
import qualified Data.Succinct.Json.Standard.Cursor.Internal.ToInterestBits64 as J
import qualified Data.Succinct.Json.Standard.Cursor.SemiIndex                 as SI
...
spec :: Spec
spec = describe "Data.Succinct.Json.Cursor.InterestBitsSpec" $ do
