...
module Data.Succinct.Json.PartialValue
  ( JsonPartialValue(..)
  , JsonPartialValueAt(..)
  , asInteger
  , asString
...
-- 'Data.Succinct.Json.LightJson.LightJson' instead.
...
class JsonPartialValueAt a where
  ...
  -- consider using 'Data.Succinct.Json.LightJson.lightJsonAt' instead.
