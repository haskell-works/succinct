...
module Data.Succinct.Json.Value where
...
-- 'Data.Succinct.Json.PartialValue.JsonPartialValue' or 'Data.Succinct.Json.LightJson.LightJson'.
data JsonValue
  = JsonString Text
  | JsonNumber Double
...
class JsonValueAt a where
  ...
  -- 'Data.Succinct.Json.PartialValue.jsonPartialJsonValueAt' or 'Data.Succinct.Json.LightJson.lightJsonAt'.
