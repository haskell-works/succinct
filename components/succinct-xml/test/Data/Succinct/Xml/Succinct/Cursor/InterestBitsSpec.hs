...
module Data.Succinct.Xml.Succinct.Cursor.InterestBitsSpec(spec) where

import Data.String
import Data.Succinct.Xml.Succinct.Cursor.BlankedXml
import Data.Succinct.Xml.Succinct.Cursor.InterestBits
import Data.Word
...
spec :: Spec
spec = describe "Data.Succinct.Xml.Succinct.Cursor.InterestBitsSpec" $ do
